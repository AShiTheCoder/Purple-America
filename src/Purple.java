...
public class Purple extends JApplet{
	...
	public class VoteSpace {
		...
		public void setColor() {
			int r = (int)(255.0*redVotes/(redVotes + greenVotes + blueVotes));
			int g = (int)(255.0*greenVotes/(redVotes + greenVotes + blueVotes));
			int b = (int)(255.0*blueVotes/(redVotes + greenVotes + blueVotes));
			c = new Color(r,g,b);
		}
	}
